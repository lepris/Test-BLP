...
const SvgMenu = props => (
  <svg width={36} height={36} {...props}>
    <defs>
      <circle id="menu_svg__a" cx={18} cy={18} r={18} />
      <path
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <g mask="url(#menu_svg__b)">
        <g transform="translate(10 9)">
          ...
          <use fill="#D8D8D8" xlinkHref="#menu_svg__c" />
          <g mask="url(#menu_svg__d)">
            <path d="M-10-9h36v36h-36z" fill="#0C75B7" />
          </g>
        </g>
      </g>
      <mask id="menu_svg__f" fill="#fff">
        <use xlinkHref="#menu_svg__e" />
      </mask>
      <use fill="#979797" fillRule="nonzero" xlinkHref="#menu_svg__e" />
      <g mask="url(#menu_svg__f)" fill="#005285">
        <path d="M0 0h36v36H0z" />
      </g>
    </g>
  </svg>
